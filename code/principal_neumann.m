function [erreurL2,erreurH1]=principal_neumann(nom_maillage)
...
affiche(UU_exact, Numtri, Coorneu, sprintf('Neumann exact -exacte%s', nom_maillage));
  % Calcul de l erreur L2
  % A COMPLETER
erreurL2 = log(sqrt((UU'-UU_exact')*MM*(UU-UU_exact))/sqrt(UU_exact'*MM*UU_exact));
